...
public class MyFrame2 extends JFrame {
        ...
        Runnable enemyTask = new Runnable() {
            ...
            public void run() {
                ...
                while (true) { // 게임이 끝날 때까지 계속 반복
                    ...
                    // 오른쪽 끝(800)px에 닿으면 방향 전환
                    if (x >= 800) {
                        movingRight = false;
                    } else if (x <= 100) {
                        // 왼쪽 끝(0)px에 닿으면 방향 전환
                        movingRight = true;
                    }
                    // 변경된 x 값을 다시 설정
    ...
    private void initData() {
        ...
        // 적군 설정 - 하단 중앙에서 시작
        enemy = new JLabel(enemyIconR); // 처음엔 오른쪽을 바라 봄
